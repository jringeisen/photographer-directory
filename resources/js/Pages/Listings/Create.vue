        ...
        <div class="mx-auto mt-10 max-w-6xl space-y-6 px-4 sm:px-0">
            <div class="flex flex-wrap items-start justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Tell clients who you are and showcase your best work.</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    <div class="rounded-lg border border-gray-200 bg-white p-6 space-y-3">
                        ...
                        <p class="text-sm text-gray-600">Select your specialties so clients can find you faster.</p>
