...
class StoreListingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'starting_price' => ['nullable', 'numeric', 'min:0', 'decimal:0,2', 'required_with:ending_price'],
            'ending_price' => ['nullable', 'numeric', 'min:0', 'decimal:0,2', 'gte:starting_price'],
            'highlights' => ['nullable', 'array', 'max:15'],
